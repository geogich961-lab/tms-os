...
- [ ] Xác minh thực địa V17.0.17 trên Xperia: khi kiểm tra cập nhật thất bại phải hiện đúng nguyên nhân từng endpoint qua nút Chẩn đoán kết nối; upload `TMS_OS_LATEST.zip` thủ công phải vượt được bước Kiểm tra và lưu; nâng cấp một chạm hoàn tất khi mạng ổn định.
