...
final class DatabaseController
{
 ...
 public function index():void{$this->guard();try{$items=$this->db->all();$error=null;}catch(Throwable $e){$items=[];$error=$e->getMessage();}tms_view('databases.index',['databases'=>$items,'error'=>$error,'flash'=>tms_pull_flash(),'csrf'=>tms_csrf_token()]);}
