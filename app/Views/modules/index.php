...
<div class="page-head"><div><p class="eyebrow">TMS OS V14 · MODULE CENTER</p><h1>Module Center</h1><p>Registry trung tâm cho kiến trúc module độc lập, có kiểm tra manifest, phụ thuộc và trạng thái hoạt động.</p></div><form method="post" action="/modules/repair"><input type="hidden" name="csrf" value="<?=tms_h($csrf)?>"><button class="btn btn-secondary">Đồng bộ registry</button></form></div>
