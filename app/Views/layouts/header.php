...
?>
<!doctype html><html lang="vi" data-theme="<?=tms_h($theme)?>"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1,viewport-fit=cover"><meta name="theme-color" content="<?=tms_h($ui['accent'])?>"><meta name="application-name" content="TMS OS"><meta name="apple-mobile-web-app-capable" content="yes"><meta name="apple-mobile-web-app-status-bar-style" content="default"><link rel="manifest" href="/manifest.php?v=13.0"><link rel="apple-touch-icon" href="/assets/icons/icon-192.png?v=13.0"><link rel="icon" href="/assets/favicon.png"><title><?=tms_h($title??tms_config('name'))?></title><style>:root{--primary:<?=tms_h($ui['accent'])?>;--primary2:<?=tms_h($ui['accent_secondary'])?>;--primary-rgb:<?=tms_h(tms_hex_rgb($ui['accent']))?>}</style><link rel="stylesheet" href="/assets/app.css?v=v13.0"><script defer src="/assets/app.js?v=v13.0"></script></head><body>
<?php if(!empty($showShell)):?><div class="os-shell"><aside class="os-sidebar" id="sidebar"><div class="os-brand"><img class="brand-logo small" src="/assets/logo-tms-os.png" alt="TMS OS"><div><strong>TMS OS</strong><span>by THCGaming</span></div></div><nav class="os-nav">
...
<a class="nav-item <?=nav_active('/internet-access',$current)?>" href="/internet-access"><span>☁</span>Internet Access</a>
