...
$cronJobService=new CronJobService();$cfdomainService=new CloudflareDomainService();$telegramCommandService=new TelegramCommandService($cronJobService,$monitoringService,$cfdomainService,null,$updateService);$accessReportService=new AccessReportService($cronJobService,$telegramCommandService);
...
$router->get('/sql',fn()=>$sqlController->index());$router->get('/api/sql/databases',fn()=>$sqlController->apiList());$router->post('/api/sql/query',fn()=>$sqlController->apiQuery());$router->get('/api/sql/tables',fn()=>$sqlController->apiTables());$router->get('/api/sql/structure',fn()=>$sqlController->apiStructure());$router->post('/api/sql/save-cell',fn()=>$sqlController->apiSaveCell());$router->post('/api/sql/delete-row',fn()=>$sqlController->apiDeleteRow());$router->post('/api/sql/insert-row',fn()=>$sqlController->apiInsertRow());$router->get('/databases',fn()=>$databaseController->index());$router->post('/databases/create',fn()=>$databaseController->create());$router->post('/databases/drop',fn()=>$databaseController->drop());$router->post('/databases/export',fn()=>$databaseController->export());$router->post('/databases/import',fn()=>$databaseController->import());$router->post('/databases/adopt',fn()=>$databaseController->adopt());
