...
$router->post('/notifications/alerts/config', fn()=>$notificationController->alertsSave());
$router->post('/notifications/alerts/run', fn()=>$notificationController->alertsRun());
$router->get('/updates', fn()=>$updateController->index());
$router->get('/api/updates/check', fn()=>$updateController->check());
$router->get('/api/updates/releases', fn()=>$updateController->releases());
...
$router->post('/updates/channel', fn()=>$updateController->channel());
$router->post('/updates/release/apply', fn()=>$updateController->releaseApply());
