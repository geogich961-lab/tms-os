...
$router->get('/logs',fn()=>$logController->index());$router->get('/settings',fn()=>$settingsController->index());$router->post('/settings/password',fn()=>$settingsController->password());$router->post('/settings/appearance',fn()=>$settingsController->appearance());$router->post('/settings/logo',fn()=>$settingsController->logo());
