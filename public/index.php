...
foreach (['AuthService', 'UnifiedSystemCoreService', 'SystemService', 'FileManagerService', 'WebsiteService', 'DatabaseService', 'BackupService', 'LogService', 'NetworkService', 'TerminalService', 'DiagnosticsService', 'PluginService', 'CronJobService', 'MonitoringService', 'UpdateService', 'ModuleService', 'ServiceManagerService', 'GuardianService', 'CloudflareDomainService', 'TelegramCommandService', 'AccessReportService', 'SqlQueryService'] as $class) {
    require $basePath . '/app/Services/' . $class . '.php';
}

foreach (['AuthController', 'DashboardController', 'FileManagerController', 'WebsiteController', 'DatabaseController', 'BackupController', 'LogController', 'SettingsController', 'NetworkController', 'TerminalController', 'DiagnosticsController', 'PluginController', 'CronController', 'TelegramWebhookController', 'MonitoringController', 'NotificationController', 'UpdateController', 'ModuleController', 'ServiceManagerController', 'GuardianController', 'CloudflareDomainController', 'SqlController'] as $class) {
